...
Adresy URL webhooków wyświetlane w edytorze, adresy „produkcyjne" rejestrowane w usłudze zewnętrznej oraz linki w wiadomościach e-mail wysyłanych przez n8n były budowane jako http://localhost:5678 — poprawnie wewnątrz kontenera i bezużytecznie wszędzie indziej. Teraz n8n otrzymuje informację, którego z Twoich adresów ma używać, a nowa akcja **Ustaw główny adres URL** pozwala go wybrać. Wybór jest ustawiany za Ciebie podczas instalacji i wybierany ponownie automatycznie, jeśli wskazywany adres przestanie być publikowany.
